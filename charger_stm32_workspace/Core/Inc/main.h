...
#define HV_LED_GPIO_Port GPIOB
#define HVIL_MCU_IN_Pin GPIO_PIN_7
#define HVIL_MCU_IN_GPIO_Port GPIOC
#define FANS_SIG_Pin GPIO_PIN_9
#define FANS_SIG_GPIO_Port GPIOC
